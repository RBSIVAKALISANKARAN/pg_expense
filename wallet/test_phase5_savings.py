...
class Phase5SavingsTests(TestCase):
    ...
    def test_savings_period_filter(self):
        ...
        response = self.client.get(
            f"/api/savings/analytics/?date_from={today}&date_to={today}"
        )
        self.assertEqual(response.status_code, 200)
