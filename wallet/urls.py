...
urlpatterns = [
    ...
    path('expense/entry/', expense_entry, name='expense-entry'),
    path('transfer/money/', transfer_between_accounts, name='transfer-money'),
    path('transactions/all/', enhanced_transaction_list, name='enhanced-transactions'),
    path('transactions/<uuid:id>/revert/', revert_transaction, name='transaction-revert'),
    path('transactions/<uuid:id>/edit/', edit_expense, name='transaction-edit-expense'),
    ...
    path('sql/', enhanced_sql_page, name='sql-playground'),
    path('sql/execute-live/', enhanced_sql_execute, name='sql-execute-live'),
    path('sql/schema-live/', sql_schema_data, name='sql-schema-live'),
