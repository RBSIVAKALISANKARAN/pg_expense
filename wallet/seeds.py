"""Standard wallet seed functions extracted from the old migration 0012.

These functions were extracted from wallet/migrations/0012_seed_standard_wallets.py
so the seed logic survives the migration reset and can be reused by the new
migration history.
"""
