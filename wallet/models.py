...
class Transaction(models.Model):
    ...
    allocation = models.ForeignKey(Allocation, on_delete=models.SET_NULL, null=True, blank=True, related_name='transactions')
    source_pool = models.ForeignKey(MoneyPool, on_delete=models.SET_NULL, null=True, blank=True, related_name='source_transactions')
    ...
    related_tx = models.ForeignKey('self', on_delete=models.SET_NULL, null=True, blank=True, related_name='linked_transactions')
