    ...
    def ready(self):
        ...
        for module in (account_money_views, complete_flow_views, feature_views):
            if hasattr(module, '_ensure_money_pool'):
                module._ensure_money_pool = financial_integrity.ensure_account_money_pool
            if hasattr(module, '_sync_account_pools'):
                module._sync_account_pools = financial_integrity.sync_account_pools_with_legacy_repair
